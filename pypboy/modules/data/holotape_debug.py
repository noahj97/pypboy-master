...
class Module(pypboy.SubModule):
    ...
    def select_holotape(self, holotape_index):
        ...
        print("Adding:", self.holotapes[holotape_index])
        self.add(self.holotapes[holotape_index])  # Use the object, not the index
        self.active_holotape = self.holotapes[holotape_index]
