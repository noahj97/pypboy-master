...
class BaseModule(game.EntityGroup):
    ...
    def switch_submodule(self, module):
        if settings.SOUND_ENABLED:
            self.submodule_change_sfx = pygame.mixer.Sound('sounds/pipboy/RotaryHorizontal/UI_PipBoy_RotaryHorizontal_01.ogg')
    ...
    def handle_pause(self):
        self.paused = True
        self.savedSubmodule = self.currentSubmodule
        # self.switch_submodule(0)
    ...
    def handle_resume(self):
        self.paused = False
        self.currentSubmodule = self.savedSubmodule  # Restore the previously active submodule
        self.switch_submodule(self.savedSubmodule)
