...
# MAP
MAP_FOCUS = (147.3054753, -42.8573136)  
...
WEAPONS = [
    ...
    ["Laser Musket", 1, "images/inventory/lasermusket", "",
     [["Damage", 30], ["Cell", 68], ["Fire Rate", 6], ["Range", 107], ["Accuracy", 70], ["Weight", 12.6],
      ["Value", 61]]],
...
FOOTER_WEAPONS = ["WEIGHT 186/210", "CAPS: 5305", "AMMO: 125", None, False]

ARMOR = [
    ["Vault 52 Jumpsuit", "", "images/inventory/armor_suit", "", [["DMG Resist", 5], ["Weight", 1], ["Value", 20]]],
    ["Mask", "", "images/inventory/armor_mask", "", [["INT", 8], ["Weight", 0.2], ["Value", 30]]],
    ["Oakleys", "", "images/inventory/armor_glasses", "", [["PER", 1], ["Weight", 0.1], ["Value", 7]]],
    ["Bike Helmet", "", "images/inventory/armor_helmet", "", [["PER", -1], ["Weight", 1], ["Value", 10]]],
    ["Leather Chest Armor", "", "images/inventory/armor_chest", "", [["PER", 1], ["Weight", 3], ["Value", 30]]],
    ["Leather Left Arm", "", "images/inventory/armor_left_arm", "", [["PER", 1], ["Weight", 3], ["Value", 30]]],
    ["Leather Right Arm", "", "images/inventory/armor_right_arm", "", [["PER", 1], ["Weight", 3], ["Value", 30]]],
    ["Leather Left Leg", "", "images/inventory/armor_left_leg", "", [["PER", 1], ["Weight", 3], ["Value", 30]]],
    ["Leather Right Leg", "", "images/inventory/armor_right_leg", "", [["PER", 1], ["Weight", 3], ["Value", 30]]],
    ["Shelias Ring", "", "images/inventory/armor_ring", "", [["Weight", 0], ["Value", 250]]],
]

FOOTER_ARMOR = ["WEIGHT 186/210", "CAPS: 5305", "ARMOR: 50 / RADIATION: 1", None, False]
...
FOOTER_AID = ["WEIGHT 186/200", "CAPS: 5305", "HEALTH", 100, False]
...
FOOTER_MISC = ["WEIGHT 186/210", "CAPS: 5305", "", None, False]

AMMO = [
    ["10mm Rounds", 57, "images/inventory/10mmAmmo"],
    ["Fusion Cells", 68, "images/inventory/fusion_cells"],
]

FOOTER_TIME = ["DATE", "TIME", "", None, False]

QUESTS = [
    ["War Never Changes","","images/quests/war_never_changes","Get to Vault 52. Survive."],
    ["Out of Time","","images/quests/out_of_time",
     "While cryogenically frozen in Vault 111, I awoke just long enough to witness the murder of my wife and the abduction of my infant son. I need to escape Vault 52 and return home, so I can begin to make sense of this tragedy."],
    ["Unlikely Valentine","","images/quests/unlikely_valentine",
     "Nick Valentine apparently went missing while investigating a case. If I want his help in locating Layne, I'll need to find him first. His last known location was Park Street Station."],
    ["Reunions","","images/quests/reunions",
     "Kellogg is dead, and Layne isn't here with him. I need to search around for some information that may lead me to my son."],
    ["The Glowing Sea","","images/quests/the_glowing_sea",
     "I need to find Chauncey, the escaped Institute scientist, somewhere in the Glowing Sea and hope that he can help me reach the Institute."],
]
